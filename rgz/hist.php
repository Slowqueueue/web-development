 ...
 class hist {
  ...
  function get () {
   ...
   for ($i=0; $i<$this->count; $i++) {
    ...
    if($i == 0) $string .= '<td class="plotDataCell"><div class="plotItemInCell1" style="width: '.$this->pixels[$i].'%;"></div></td>'."\n";
    if($i == 1) $string .= '<td class="plotDataCell"><div class="plotItemInCell2" style="width: '.$this->pixels[$i].'%;"></div></td>'."\n";
    if($i == 2) $string .= '<td class="plotDataCell"><div class="plotItemInCell3" style="width: '.$this->pixels[$i].'%;"></div></td>'."\n";
